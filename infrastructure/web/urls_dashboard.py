...
urlpatterns = [
    ...
    path('admin-panel/deployments/', deployment_views.deployments_list_view, name='admin_deployments'),
    path('admin-panel/deployments/create/', deployment_views.create_deployment_view, name='admin_create_deployment'),
    path('admin-panel/deployments/<uuid:deployment_id>/', deployment_views.deployment_detail_view, name='admin_deployment_detail'),
    path('admin-panel/deployments/<uuid:deployment_id>/deploy/', deployment_views.deploy_project_action, name='admin_deploy_project'),
    path('admin-panel/deployments/<uuid:deployment_id>/stop/', deployment_views.stop_deployment_action, name='admin_stop_deployment'),
    path('admin-panel/deployments/<uuid:deployment_id>/restart/', deployment_views.restart_deployment_action, name='admin_restart_deployment'),
